...
test("Fetch TextualDocument with source records", async () => {
    ...
    expect(textualDocument?.publication_date).toEqual("2012-09-19");
    expect(textualDocument?.publication_date_start).toEqual(
        "2012-09-19T00:00:00.000Z"
    );
    expect(textualDocument?.publication_date_end).toEqual(
